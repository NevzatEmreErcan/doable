...
const AddGoalSlide = ({ setIsSlideInOpen, handleAddGoal }) => {
  /* Dom States */
  const [isColorTagOpen, setIsColorTagOpen] = useState(false);
  const [isTargetCustomOpen, setIsTargetCustomOpen] = useState(false);
  ...
  function handleDeadline(value) {
    ...
    switch (value) {
      case "this-month":
        setSelectedDeadline({ month: todaysDate.getMonth() });
        break;
      case "next-month":
        setSelectedDeadline({ month: todaysDate.getMonth() + 1 });
        break;
      case "this-year":
        setSelectedDeadline({ year: todaysDate.getFullYear() });
        break;
      case "someday":
