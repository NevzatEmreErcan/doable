...
const EditRoutineSlide = ({ routine, setIsSlideInOpen, handleEditRoutine }) => {
  /* Dom States */
  ...
  const [selectedColorTag, setSelectedColorTag] = useState(routine.colorTag);
  const [selectedRepeat, setSelectedRepeat] = useState(routine.repeat);
  ...
  useEffect(() => {
    if (routine.repeat === "daily") {
      ...
      setSelectedRepeatButton("weekly");
      setSelectedRepeatDays(routine.repeat);
    }
  }, []);
  ...
  function handleSubmit() {
    if (!title.trim()) {
      ...
      handleEditRoutine(editedRoutine);
...
export default EditRoutineSlide;
